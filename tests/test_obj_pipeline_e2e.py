...
class ObjPipelineEndToEndTests(unittest.TestCase):
    def test_fixture_pipeline_normalizes_and_renders_linked_artifacts(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            ...
            source = surface_dir / "hs5_cfd.obj"
            ...
            self.assertEqual("constant/triSurface/hs5_cfd.obj", region_manifest["sourceObj"])
            ...
            self.assertEqual(region_manifest["sourceObj"], case_manifest["geometry"]["rawCfdObj"])
